...
#include "Transaction_2014.h"

string Transaction2014::buildXmlBody(string sb)
{
...
string Transaction2014::getType()
{
    return "2014";
}

void Transaction2014::handleData(xml_node<>* resultData)
{
...
void Transaction2014::handleVersionData(xml_node<>* resultData)
{
    auto node = resultData->first_node();
