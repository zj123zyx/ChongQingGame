...
int lua_cocos2dx_cocosbuilder_CCBAnimationManager_runCustomAnimationsForSequenceIdTweenDuration(lua_State* tolua_S)
{
    int argc = 0;
    cocosbuilder::CCBAnimationManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_cocosbuilder_CCBAnimationManager_runCustomAnimationsForSequenceIdTweenDuration'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "cc.CCBAnimationManager:runCustomAnimationsForSequenceIdTweenDuration");
        
        ok &= luaval_to_number(tolua_S, 3,&arg1, "cc.CCBAnimationManager:runCustomAnimationsForSequenceIdTweenDuration");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_cocosbuilder_CCBAnimationManager_runCustomAnimationsForSequenceIdTweenDuration'", nullptr);
            return 0;
        }
        cobj->runCustomAnimationsForSequenceIdTweenDuration(arg0, arg1);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.CCBAnimationManager:runCustomAnimationsForSequenceIdTweenDuration",argc, 2);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_cocosbuilder_CCBAnimationManager_runCustomAnimationsForSequenceIdTweenDuration'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_cocosbuilder_CCBAnimationManager(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"CCBAnimationManager");
        ...
        tolua_function(tolua_S,"runCustomAnimationsForSequenceIdTweenDuration",lua_cocos2dx_cocosbuilder_CCBAnimationManager_runCustomAnimationsForSequenceIdTweenDuration);
